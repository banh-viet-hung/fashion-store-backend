...
public class ApiAccessConfig {
    ...
    public static final String[] STAFF_ADMIN_API_POST = {"/orders/{orderId}/update-status", "/products/create", "/product-variant/{productId}/variants", "products/{productId}/images", "/products/delete/{productId}", "/products/update/{productId}", "/categories/create", "/categories/{id}", "/products/delete-many", "/categories/delete-many"};

    public static final String[] ADMIN_API_GET = {"/user/all", "/user/info/{username}"};

    public static final String[] ADMIN_API_POST = { "/user/update-role/{username}", "/user/change-status/{username}", "/user/admin/create-user"};
}
