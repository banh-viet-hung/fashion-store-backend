...
public class ApiAccessConfig {
    ...
    public static final String[] PUBLIC_API_POST = {"/user/register", "/api/auth/login", "orders/create", "/payment/update-status/{orderId}", "/orders/{orderId}/cancel", "/products/filter", "/user/check-email"};
