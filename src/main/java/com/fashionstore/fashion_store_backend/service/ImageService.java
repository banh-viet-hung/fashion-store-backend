...
public class ImageService {
    ...
    public void updateProductImages(Long productId, ProductImagesCreateDto requestDto) throws Exception {
        // Lấy sản phẩm từ ID
        ...
        if (existingImages != null && !existingImages.isEmpty()) {
            imageRepository.deleteAll(existingImages);  // Xóa tất cả các hình ảnh cũ
        }
